...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2017 at 11:56 AM
...
(6, 1, 'При посещении сайта вы сталкиваетесь предложением «Зарегистрироваться», для чего это надо? <br />\r\n									Зарегистрированному посетителю сайта будет доступна все наши сервисы:', '1. <i>совершать онлайн покупки</i><br />\r\n2. <i>оставлять свои сообщения, комментарии</i><br />\r\n3. <i>читать новости</i> <br />\r\n4. <i>получать рассылки о предстоящих событиях</i><br /> \r\nДля этого вам нужно потратить пару минут. Требуется пароль, которые вы сами себе придумаете, а также адрес вашей электронной почты.<br />\r\nЗаполненная вся информация с вашими данными во время регистрации останутся скрытыми она не будет доступна для третьих лиц.		');
...
(2, 1, 2, '2017-08-11 00:00:00', '2017-08-11 00:00:00', 17, 15, 19, 30, '200x150_pic22.png'),
