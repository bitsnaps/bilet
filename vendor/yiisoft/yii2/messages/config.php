...
return [
    ...
    'languages' => ['ar', 'az', 'bg', 'bs', 'ca', 'cs', 'da', 'de', 'el', 'es', 'et', 'fa', 'fi', 'fr', 'he', 'hr', 'hu', 'id', 'it', 'ja', 'ka', 'kk', 'ko', 'lt', 'lv', 'ms', 'nb-NO', 'nl', 'pl', 'pt', 'pt-BR', 'ro', 'ru', 'ru-RU', 'sk', 'sl', 'sr', 'sr-Latn', 'sv', 'tg', 'th', 'tk-TKM', 'uk', 'vi', 'zh-CN', 'zh-TW'],
