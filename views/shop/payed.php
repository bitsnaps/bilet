...
<div class="container" style="margin-top: 2%;">
    <div class="row" style="margin-top: 10%;margin-bottom:10%;">
		<div class="col-md-12 text-center">
			<h5><?= \Yii::t('app', 'Payment Success'); ?></h5>
			<h5><?= \Yii::t('app', 'Email has sent to your mail'); ?></h5>
			<h5><?= \Yii::t('app', 'Thank you!'); ?></h5>
		</div>
		...
		<div class="col-md-12" style="margin-top: 3%;background-color: whitesmoke;">
			...
			<div class="col-md-offset-2 col-md-2">
				<?= 
					...
					'<h5><b>', \Yii::t('app', 'Auditorium'), '</b></h5><br />',
				...
				<?=
					...
					'<h5><b>', \Yii::t('app', 'Your balance is: '), '</b></h5><br />';
				?>
			</div>
