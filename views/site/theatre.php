    ...
    <div class="row theatreInfoTitleRow">
        <div class="col-md-12">
            <center><img class="img-responsive" src="img/sep.png" alt="">
                <h4 ><?= \Yii::t('app', 'Theatres of the city Ashgabat'); ?></h4>
            ...
            <div class='row theatreInfoRow'>
                ...
                <div class='col-sm-8'>
                    <h4 class='text-center text-capitalize'>
						<?= Html::a(Html::encode($cultural_place_translation[$i]->place_name), ['theatre/about-theatre', 'id' => $cultural_place[$i]->id]) ?>
                    </h4>
